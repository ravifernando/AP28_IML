...
long long N0 = constantsList[constantsIndex][13];
...
STEP4=STEP*4;
STEP5=STEP*5;
// Overflow-safe modular multiplication replaces the old "num trick" (2^62 / MOD split)
...
s89=SPRIME7%89;
s97=SPRIME7%97;
// s101=S61%101; // If needed, uncomment.
